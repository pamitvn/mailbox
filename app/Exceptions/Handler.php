    ...
    public function render($request, Throwable $e)
    {
        if ($e instanceof AuthorizationException) {
            return $this->isApi($request)
                ? response()->json(ApiResponse::withFailed()->withMessage($e->getMessage()))
                : send_message_if(
                    boolean: false,
                    message: __('Unknown message'),
                    unlessMessage: $e->getMessage() ?? __('You are not allowed to perform this action'),
                    allowBack: true
                );
        }
