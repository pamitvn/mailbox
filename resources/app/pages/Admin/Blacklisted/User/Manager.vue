<template>
   <the-head>
      <title>User Blacklist Managers</title>
   </the-head>
   <crud-layout title='User Blacklist Managers' has-search>
      <template #header-action>
         <the-link :href='$route("admin.blacklisted.user.create")'>
            <v-button outline>
               Add
            </v-button>
         </the-link>
      ...
      <v-crud-table
         :columns='columns'
         :data='paginationData'
         title='All user blacklists are available here.'
      >
         ...
         <template #row-action='{row}'>
            <td class='table--col'>
               <the-link :href='$route("admin.blacklisted.user.edit", row.id)'>
